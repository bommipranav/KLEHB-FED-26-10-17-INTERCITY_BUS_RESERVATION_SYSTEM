...
To allow users to select their route, travel date, and bus.

To provide a 60-seat layout for easy seat selection.

To prevent users from booking already occupied seats.

To allow users to book multiple seats in one booking.

To collect and store basic customer details.

To verify the booking using an OTP.
